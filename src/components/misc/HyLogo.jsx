...
const HyLogo = ({ height = 64, width = 64, fill = "#000000", ...rest }) => {
  return (
    <svg viewBox="0 0 1000 1000" height={height} width={width} fill={fill} xmlns="http://www.w3.org/2000/svg" { ...rest }>
